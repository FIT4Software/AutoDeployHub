...
SELECT
		@SP_Name	= 'fnLocal_RptStartEndTime',
		@Inputs		= 1,
		@Version	= '2.4'
...
IF EXISTS (
			SELECT * FROM dbo.sysobjects 
				WHERE name = 'fnLocal_RptStartEndTime'
			)
DROP function [dbo].[fnLocal_RptStartEndTime]
-----------------------------------------------------------------------------------------------------------------------
GO
...
GO
GRANT SELECT ON [dbo].[fnLocal_RptStartEndTime] TO OpDBManager AS [dbo]
GO
